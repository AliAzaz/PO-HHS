...
import edu.aku.hassannaqvi.uen_po_hhs.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.BLRandomContract;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.BLRandomContract.singleChild;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.DeceasedChildContract;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.DeceasedChildContract.DeceasedChild;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.DeceasedMotherContract;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.DeceasedMotherContract.DeceasedMother;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.FormsContract;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.MWRAContract;
import edu.aku.hassannaqvi.uen_po_hhs.contracts.MWRAContract.MWRATable;
...
import edu.aku.hassannaqvi.uen_po_hhs.contracts.TalukasContract.singleTalukas;
...
import edu.aku.hassannaqvi.uen_po_hhs.contracts.VillagesContract.singleVillages;
import edu.aku.hassannaqvi.uen_po_hhs.otherClasses.MotherLst;

import static edu.aku.hassannaqvi.uen_po_hhs.contracts.SectionIIMContract.singleIm;
