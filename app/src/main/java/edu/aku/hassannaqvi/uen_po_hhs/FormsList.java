package edu.aku.hassannaqvi.uen_po_hhs;
...
public class FormsList extends Activity {
    ...
    @BindView(edu.aku.hassannaqvi.uen_po_hhs.R.id.totalForms)
    TextView totalForms;
    @BindView(edu.aku.hassannaqvi.uen_po_hhs.R.id.completeForms)
    TextView completeForms;
    @BindView(edu.aku.hassannaqvi.uen_po_hhs.R.id.psuNoTxt)
    TextView psuNoTxt;
    @BindView(edu.aku.hassannaqvi.uen_po_hhs.R.id.FormsList)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(edu.aku.hassannaqvi.uen_po_hhs.R.layout.activity_forms_list);
