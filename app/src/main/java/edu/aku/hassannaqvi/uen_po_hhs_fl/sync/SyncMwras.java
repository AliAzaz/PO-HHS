...
public class SyncMwras extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " MWRA's synced." + (json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " MWRA's synced." + (json.length() - sSynced) + " Errors: " + sSyncedError);
