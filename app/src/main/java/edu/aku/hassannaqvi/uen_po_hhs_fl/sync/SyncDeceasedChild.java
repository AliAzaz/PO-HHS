...
public class SyncDeceasedChild extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " Deceased Child synced." + (json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " Deceased Child synced." + (json.length() - sSynced) + " Errors: " + sSyncedError);
