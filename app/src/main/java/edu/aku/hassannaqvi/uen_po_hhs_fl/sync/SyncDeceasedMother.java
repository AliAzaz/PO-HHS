package edu.aku.hassannaqvi.uen_po_hhs_fl.sync;
...
public class SyncDeceasedMother extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            Toast.makeText(mContext, sSynced + " Deceased Mothers synced." + (json.length() - sSynced) + " Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();

            pd.setMessage(sSynced + " Deceased Mothers synced." + (json.length() - sSynced) + " Errors: " + sSyncedError);
